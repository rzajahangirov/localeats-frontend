...
const PartnerRegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Step 2: Auto-Login ("The Bridge")
      setLoadingText('Setting up your partner account...');
      ...
      // Redirect to restaurant creation now that JWT is established
      navigate('/partner/create-restaurant');
    } catch (err) {
        ...
        <div className="register-hero">
          <div className="hero-content">
            ...
            <h1 className="hero-title animate-fade-in-up delay-1">
              Elevate Your<br />
              Culinary <span className="hero-title-accent">Legacy</span>
            </h1>
            <p className="hero-subtitle animate-fade-in-up delay-2">
              Join our curated network of exceptional restaurants and reach food lovers who appreciate the art of dining.
            </p>
          ...
          <div className="form-container animate-slide-in-right">
            ...
            <form onSubmit={handleSubmit} className="register-form" id="register-form" noValidate>
              ...
              >
                {loading ? (
                  <>
                    ...
                    <span style={{ marginLeft: '0.5rem', fontSize: '0.9rem' }}>{loadingText || 'Creating Account...'}</span>
                  </>
                ) : (
                  <>
                    Create Account
              ...
              <div className="form-footer-text">
                ...
                <p style={{ marginTop: '0.5rem' }}>Just want to order food? <Link to="/register" className="form-link">Sign up here</Link></p>
              </div>
            </form>
          </div>
        </div>
